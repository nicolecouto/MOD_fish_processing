...
u.dissrate = struct('unit', 'raw', 'description', 'Onboard dissipation-rate estimates - passes through L1 unchanged. Not the same as this repo''s own epsilon_obs/epsilon_mle (mod_scan_calc_epsilon.m).');
